...
| [`architecture_review_and_aws_roadmap.md`](architecture_review_and_aws_roadmap.md) | Recommends an AWS ECS Fargate production architecture at ~$350–500/month. [ADR-010](../adr/010-deployment-topology.md) selects an interim VPS, then CIT-U on-premise | [`../adr/010-deployment-topology.md`](../adr/010-deployment-topology.md) | `architecture-review/01`, `10` · `architecture-tasks/11` |
