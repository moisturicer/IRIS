 ...
 *    so they stay legible on maroon message bubbles and dark surfaces.
 *
 * The amber accent that used to mark AI affordances is gone (IR-356): the
 * interface is white, black, grey and maroon, so the emblem's accents are
 * maroon shades and a pale maroon tint, and the line icons' accents follow
 * `currentColor`. The "IRIS AI" label, not a hue, is what marks AI content.
 */
    ...
    <svg viewBox="0 0 48 48" className={className} fill="none" {...a11y(title)}>
      <defs>
        <linearGradient id={grad} x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="100%" stopColor="#4A0A0C" />
        </linearGradient>
      ...
      <circle
        cx="24" cy="24" r="15"
        stroke="#F9B8B9" strokeWidth="1" strokeDasharray="2 4" opacity="0.8"
      />
      ...
      <circle cx="36" cy="12" r="2" fill="#8B1316" />
      <circle cx="12" cy="36" r="1.5" fill="#F9B8B9" />
...
export function AskIrisMark({ className = "w-5 h-5", title }: IconProps) {
  return (
    ...
    >
      ...
      <line x1="2.5" y1="6" x2="4.5" y2="6" stroke="currentColor" strokeWidth="1.8" />
      <line x1="19.5" y1="6" x2="21.5" y2="6" stroke="currentColor" strokeWidth="1.8" />
      <line x1="3.9" y1="3.6" x2="5.1" y2="4.8" stroke="currentColor" strokeWidth="1.5" />
      <line x1="20.1" y1="3.6" x2="18.9" y2="4.8" stroke="currentColor" strokeWidth="1.5" />
    </svg>
  );
}
...
export function GroundedCitationIcon({ className = "w-4 h-4", title }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M8.75 13.25l2.25 2.25 4.25-4.25" stroke="#6B0F12" strokeWidth="2.2" />
    </svg>
  );
}
...
export function SynthesisIcon({
  ...
  return (
    ...
    >
      ...
      <path d="M3 3v5h5" />
      <path d="M3 12a9 9 0 0 0 9 9 9.75 9.75 0 0 0 6.74-2.74L21 16" stroke="currentColor" />
      <path d="M16 21h5v-5" stroke="currentColor" />
